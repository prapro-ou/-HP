# COUNTER CORE - 開発プロジェクト

本作は「避ける」のではなく「奪う（パリィ）」ことを主戦術とする、ジャストガード反撃型シューティングゲームです。
...
ジャストガードによる敵弾の反撃体験をさらに深化させ、多彩な武器・シールドの組み合わせ、ボスの部位破壊、音声アシストAI、およびラボによる能力強化などを備えた本格的なSTGゲームを構築します。
