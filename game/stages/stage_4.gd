...
func _setup_waves() -> void:
	...
	w1.initial_spawns = [
		...
		WaveSpawnConfig.new("blade", 0.35, -80.0),
		WaveSpawnConfig.new("missile", 0.65, -60.0),
		WaveSpawnConfig.new("blade", 0.85, -80.0)
	]
	waves.append(w1)
	...
	w2.initial_spawns = [
		WaveSpawnConfig.new("blade", 0.12, -70.0),
		WaveSpawnConfig.new("vortex", 0.32, -90.0),
	...
	w3.initial_spawns = [
		WaveSpawnConfig.new("blade", 0.10, -60.0),
		WaveSpawnConfig.new("thunder", 0.30, -90.0),
		WaveSpawnConfig.new("laser", 0.50, -60.0),
		WaveSpawnConfig.new("vortex", 0.70, -90.0),
