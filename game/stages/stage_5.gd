...
func _setup_waves() -> void:
	...
	w1.initial_spawns = [
		...
		WaveSpawnConfig.new("thunder", 0.46, -60.0),
	...
	w2.initial_spawns = [
		...
		WaveSpawnConfig.new("blade", 0.50, -70.0),
		WaveSpawnConfig.new("thunder", 0.70, -90.0),
		WaveSpawnConfig.new("missile", 0.88, -70.0)
	]
	waves.append(w2)
	...
	w3.initial_spawns = [
		...
		WaveSpawnConfig.new("blade", 0.28, -90.0),
		WaveSpawnConfig.new("vortex", 0.46, -70.0),
		WaveSpawnConfig.new("thunder", 0.64, -90.0),
		WaveSpawnConfig.new("missile", 0.82, -70.0),
	...
	w4.initial_spawns = [
		WaveSpawnConfig.new("blade", 0.10, -70.0),
		WaveSpawnConfig.new("vortex", 0.25, -90.0),
		WaveSpawnConfig.new("thunder", 0.45, -70.0),
		WaveSpawnConfig.new("laser", 0.65, -90.0),
